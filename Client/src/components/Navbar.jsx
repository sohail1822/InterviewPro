...
import { FaTheRedYeti, FaUserAstronaut } from 'react-icons/fa'
        ...
        <div className='bg-[#f3f3f3] flex justify-center px-4 pt-6'>
            <motion.div
                ...
                <div className='flex items-center gap-3 cursor-pointer'>
                    ...
                    <h1 className='font-semibold hidden md:block text-lg'>InterviewPro.AI</h1>
                </div>
                ...
                <div className='flex items-center gap-6 relative'>
                    <div className='relative '>
                        ...
                        {showCreditPopup && (
                            <div className='absolute right-[-50px] mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded p-5 z-50'>
                                <p className='text-sm text-gray-600 mb-4 '>You're out of credits—add more to continue your interview.</p>
                    ...
                    <div className='relative '>
                        ...
                        {showUserPopup && (
                            <div className='absolute right- mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-4 z-50'>
