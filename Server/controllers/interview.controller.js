...
export const analyzeResume = async (req, res) => {
  try {
    ...
    // while using this AI response is not pure JSON ,
    // therefore we need to clean it before
    // parsing and hence i am parsing it after removing the unwanted characters from the response
